    ...
    insurancePlans: [
      {
        ...
        selectedText: '已选择',
        features: {
          damage:  {main:'1500元内自付',sub:'不含轮胎轮毂'},
          thirdParty:  {main:'50万'},
          depreciation:  {main:'车损\n5000以下免收'},
          operationLoss:  {main:'不免收'},
          costDisplay:  {main:'¥1/日\n已含'}
        }
      },
      {
        id: 'upgrade',
        ...
        selectedText: '已选择',
        features: {
          damage:{main:'全额赔付',sub:'不含轮胎轮毂'},
          thirdParty:  {main:'100万'},
          depreciation:  {main:'车损\n5000以下免收'},
          operationLoss:  {main:'不免收'},
          costDisplay:  {main:'+¥50/日'}
        }
      },
      {
        id: 'premium',
        ...
        features: {
          damage: {main:'全额赔付'},
          thirdParty: {main:'200万'},
          depreciation: {main:'车损\n3万以下免收'},
          operationLoss: {main:'租金损失\n1万以下免收'},
          costDisplay: {main:'+¥80/日'}
        }
      }
    ],
